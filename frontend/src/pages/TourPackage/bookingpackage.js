            ...
            <div className="add-tour-package">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" id="customerNIC" value={customerNIC} onChange={(e) => setCustomerNIC(e.target.value)} required />
                    </div>
                    <div className="form-group">
                        <label htmlFor="phoneNumber">Phone Number:</label>
                        <input type="tel" id="phoneNumber" pattern="[0-9]{10}" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} required />
                        <small>Phone number must be exactly 10 digits long.</small>
                    </div>
                    <div className="form-group">
                        <label htmlFor="numOfPersons">Number of Persons:</label>
                        <input type="number" id="numOfPersons" value={numOfPersons} onChange={(e) => setNumOfPersons(parseInt(e.target.value))} required />
                    </div>
