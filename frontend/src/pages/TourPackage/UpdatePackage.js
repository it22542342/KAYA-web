...
import './UpdatePackage.css'; // Import CSS file for styling
...
const UpdatePackage = () => {
    ...
    const navigate = useNavigate(); // Get the package ID from the URL
            ...
            <div className="update-package-container">
                ...
                <form onSubmit={update}>
                    <div className="input-group">
                        ...
                        <input className="update-package-input" type="text" id="packageName" value={packageName} onChange={(e) => setPackageName(e.target.value)} />
                    </div>
                    <div className="input-group">
                        <label className="update-package-label" htmlFor="customerName">Customer Name:</label>
                        <input className="update-package-input" type="text" id="customerName" value={customerName} onChange={(e) => setCustomerName(e.target.value)} />
                    </div>
                    <div className="input-group">
                        <label className="update-package-label" htmlFor="customerNIC">Customer NIC:</label>
                        <input className="update-package-input" type="text" id="customerNIC" value={customerNIC} onChange={(e) => setCustomerNIC(e.target.value)} />
                    </div>
                    <div className="input-group">
                        <label className="update-package-label" htmlFor="phoneNumber">Phone Number:</label>
                        <input className="update-package-input" type="text" id="phoneNumber" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />
                    </div>
                    <div className="input-group">
                        <label className="update-package-label" htmlFor="numOfPersons">Number of Persons:</label>
                        <input className="update-package-input" type="number" id="numOfPersons" value={numOfPersons} onChange={(e) => setNumOfPersons(parseInt(e.target.value))} />
                    </div>
                    <br />
                    <button className="update-package-button" type="submit">Save Changes</button>
                    <button className="update-package-button" type="button" onClick={() => navigate('/PackageManage')}>Cancel</button>
                </form>
            </div>
        </div>
    );
