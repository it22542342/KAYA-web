...
const UpdateReview = () => {
    ...
    const update = (e) => {
        ...
        if (invalidCharsRegex.test(fbdescription)) {
            alert("Feedback description should not contain numbers or special characters.");
            return;
        }
        ...
        <div>
            ...
            <div className="update-review-container">
                ...
                <form onSubmit={update}>
                    ...
                    <button className="update-review-button" type="button" onClick={() => navigate('/MyReview')}>Cancel</button>
                </form>
            </div>
        </div>
    );
