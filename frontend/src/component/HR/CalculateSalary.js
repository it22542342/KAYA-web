...
function CalSala() {
  ...
  const calculateSalary = () => {
    ...
    const EPF = 0.08 * monthlySalary; // 8% of monthly salary for EPF
    const ETF = 0.03 * monthlySalary; // 3% of monthly salary for ETF
    const employerContributionEPF = 0.12 * monthlySalary; // 12% of monthly salary for EPF employer contribution
    const employerContributionETF = 0.03 * monthlySalary; // 3% of monthly salary for ETF employer contribution
    const totalContributionEPF = EPF + employerContributionEPF; // Total EPF contribution
    const netSalary = monthlySalary - EPF; // Net salary after deducting percentage
    setFormData(prevState => ({
      ...prevState,
