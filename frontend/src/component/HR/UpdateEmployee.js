...
import './UpdateEmployee.css'; // Import CSS file for styling
...
const UpdateEmployee = () => {
    ...
    const navigate = useNavigate(); // Get the payroll ID from the URL

    useEffect(() => {
        // Fetch the payroll details using the ID
    ...
    return (
        ...
        <div className="update-employee-container">
            ...
            <form onSubmit={update}>
                ...
                <button className="update-employee-button" type="submit">Cancel</button>
            </form>
        </div>
        </div>
    );
