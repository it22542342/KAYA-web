...
function LoanForm() {
  ...
  return (
    <div className="custom-add-loan-form-container"> {/* Updated class name */}
              ...
              <div className="custom-card-body">
                <form onSubmit={sendData}>
                  <div className="custom-form-group">
                    ...
                    <input type="text" className="custom-form-control" value={Employee_Name} onChange={(e) => setEmployeeName(e.target.value)} required />
                  </div>
                  <div className="custom-form-group">
                  ...
                  <div className="custom-form-group">
                    ...
                    <div className="custom-input-group">
                      ...
                      <input type="number" className="custom-form-control" value={Loan_Amount} onChange={(e) => setLoan_Amount(e.target.value)} required />
                    </div>
                  </div>
                  <div className="custom-form-group">
                    <label>Interest Rate (%)</label>
                    <input type="number" className="custom-form-control" value={Interest_rate} onChange={(e) => setInterest_rate(e.target.value)} required />
                  </div>
                  <div className="custom-form-group">
                    <label>Premium</label>
                    <div className="custom-input-group">
                      ...
                      <input type="number" className="custom-form-control" value={Premium} onChange={(e) => setPremium(e.target.value)} required />
                    </div>
                  </div>
                  <div className="custom-form-group">
                    <label>Repayment Period (months)</label>
                    <input type="number" className="custom-form-control" value={Repayment_period} onChange={(e) => setRepayment_period(e.target.value)} required />
                  </div>
                  <div className="custom-form-group">
